...
/** \def CPU_TYPE
  ...
  commented out.
*/
//#define CPU_TYPE stm32f411

/** \def CPU
  CPU actually present on the board.
*/
#define CPU                      stm32f411
...
DEFINE_TEMP_SENSOR(extruder, TT_THERMISTOR, PB_0,  THERMISTOR_EXTRUDER)
